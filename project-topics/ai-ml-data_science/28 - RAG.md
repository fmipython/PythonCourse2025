...
1. **Извличане на информация (Retrieval)**. "Външното знание" на бота. Целта на тази стъпка е да се извлече най-релевантният контекст, който след това да бъде подаден на езиковия модел. Това може да бъде търсене в интернет, ровене из налични локално файлове, търсене в бази данни или бази знания.
